...
const nodes = [
	...
	},
	{
		...
		responsibilities: [
			"Uses `DuckPlayerDataV1` and schema version 6.",
			"Sanitizes saved currencies, ducks, quest progress, inventory, upgrade level, and daily claim day.",
	...
	},
	{
		...
		responsibilities: [
			"Persists coins, eggs, inventory, ready eggs, Egg Value level, ducks, quest progress, next duck id, and last daily claim day.",
		],
	},
	{
		id: "gameplay-systems",
...
const edges = [
	...
	{ from: "player-state-service", to: "save-data-v6", type: "data", label: "creates save snapshots" },
	{ from: "save-data-v6", to: "player-data-service", type: "data", label: "sanitized and persisted" },
	{ from: "save-data-v6", to: "datastore-api", type: "data", label: "stored in DuckPlayerDataV1" },
