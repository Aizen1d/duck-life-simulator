...
const nodes = [
	...
	},
	{
		...
		responsibilities: [
			"Uses `DuckPlayerDataV1` and schema version 8.",
			"Sanitizes saved currencies, ducks, quest progress, inventory, upgrade level, daily claim day, streak day, and the last-seen timestamp (clamped against forged future values).",
	...
	},
	{
		...
		responsibilities: [
			"Persists coins, eggs, inventory, ready eggs, Egg Value level, ducks, quest progress, next duck id, last daily claim day, streak day, and the last-seen timestamp for offline progress.",
		],
	},
	{
		id: "gameplay-systems",
...
const edges = [
	...
	{ from: "player-state-service", to: "save-data-v8", type: "data", label: "creates save snapshots" },
	{ from: "save-data-v8", to: "player-data-service", type: "data", label: "sanitized and persisted" },
	{ from: "save-data-v8", to: "datastore-api", type: "data", label: "stored in DuckPlayerDataV1" },
